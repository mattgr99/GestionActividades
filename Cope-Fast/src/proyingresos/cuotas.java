...
public class cuotas extends javax.swing.JFrame {
    ...
    public cuotas() {
        ...
        try {
            ...
            String sql = "SELECT cedula, nombre, valor_cuota, motivo_cuota FROM cuotas";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 340, 328, 79));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(552, 441, 130, 40));
...
txtCampo.setText("");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            ps = conn.prepareStatement("INSERT INTO cuotas (cedula, nombre, valor_cuota, motivo_cuota) VALUES (?,?,?,?)");

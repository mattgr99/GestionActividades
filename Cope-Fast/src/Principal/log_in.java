...
public class log_in extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbousuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Gerente", "Subgerente", "Tesorero" }));
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        ...
        if (usr.equals("Gerente") && pwd.equals("12345")) {
            ...
            Principal.txtnombre.setText(cbousuario.getSelectedItem().toString());
            this.hide();
            
        } else {
            er++;
        }
        if (usr.equals("Subgerente") && pwd.equals("12345")) {
            JOptionPane.showMessageDialog(null, "Usuario Correcto");
        ...
        if (usr.equals("Tesorero") && pwd.equals("12345")) {
            JOptionPane.showMessageDialog(null, "Usuario Correcto");
